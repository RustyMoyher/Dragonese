...
Possibly you can fix this vy copying the file in this directory into C:\Windows\System32 (if it is already there, please rename the previous one before copying).
